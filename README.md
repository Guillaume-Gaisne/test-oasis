![docker image](https://github.com/Guillaume-Gaisne/test-oasis/actions/workflows/docker-publish.yml/badge.svg)
...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    git clone https://github.com/Guillaume-Gaisne/test-oasis.git
    cd test-oasis
    ```
    ...
    ```sh
    curl-L -o test-oasis.zip "https://github.com/Guillaume-Gaisne/test-oasis/archive/main.zip"
    unzip test-oasis.zip
    cd test-oasis
    ```
...
your `docker-compose.yaml` with `ghcr.io/guillaume-gaisne/test-oasis:main` for the services
...
and advanced configuration, see the [nomad-helm-charts](https://github.com/Guillaume-Gaisne/nomad-helm-charts) repository.
...
```sh
docker pull ghcr.io/guillaume-gaisne/test-oasis/jupyter:main
```
...
_I get an_ `Error response from daemon: Head "https://ghcr.io/v2/Guillaume-Gaisne/test-oasis/manifests/main": unauthorized`
